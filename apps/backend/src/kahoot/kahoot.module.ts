...
@Module({
  ...
  // in handlePollAnswer can call kahootService.answer. KahootGateway is exported
  // too so the /join path can refresh the host lobby instantly.
  exports: [KahootService, KahootGateway],
})
